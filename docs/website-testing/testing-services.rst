...
#. `securityheaders.com <https://securityheaders.com>`_ an analyzer and rating system for your HTTP response headers
#. `CFSSL <https://cfssl.org>`_ "CFSSL is CloudFlare's PKI/TLS swiss army knife. It is both a command line tool and an HTTP API server for signing, verifying, and bundling TLS certificates."
